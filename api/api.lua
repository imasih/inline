...
local json = (loadfile "/home/bot/inline/data/JSON.lua")()
local token = '261919398:AAFP_Lgt3X8zA0WT9E3PjsKLYCgnMGCcTl0' --token
       ...
       if h == -1 then
        ...
        elseif is_lock(chat,value) then
          ...
          return '🔓'
            ...
            else Canswer(q.id,'شما مالک/مدیر گروه نیستید و امکان تغییر تنظیمات را ندارید!',true)
						end
						end
